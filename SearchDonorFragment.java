...
public class SearchDonorFragment extends Fragment {
    ...
    Spinner bloodgroup;
    Spinner division; // Add division Spinner
    Button btnsearch;
    ProgressDialog pd;
    List<DonorData> donorItem;
    private RecyclerView recyclerView;
    ...
    private String currentDivision = "Rajshahi"; // Default division is set to "Rajshahi"
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        bloodgroup = view.findViewById(R.id.btngetBloodGroup);
        division = view.findViewById(R.id.btngetDivison); // Initialize the division Spinner
        btnsearch = view.findViewById(R.id.btnSearch);

        // Set the default division as "Rajshahi"
        String[] divisionArray = getResources().getStringArray(R.array.division_list);
        ArrayAdapter<String> divisionAdapter = new ArrayAdapter<>(getActivity(), android.R.layout.simple_spinner_item, divisionArray);
        divisionAdapter.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
        division.setAdapter(divisionAdapter);
        int defaultDivisionPosition = divisionAdapter.getPosition("Rajshahi");
        division.setSelection(defaultDivisionPosition);
        ...
        btnsearch.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                currentDivision = division.getSelectedItem().toString(); // Update the currentDivision

                String selectedDivision = currentDivision;
                Query qpath = db_ref.child(selectedDivision).child(bloodgroup.getSelectedItem().toString());
                qpath.addListenerForSingleValueEvent(new ValueEventListener() {
                    @Override
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        if (dataSnapshot.exists()) {
